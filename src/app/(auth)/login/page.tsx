  ...
  return (
    <div className="flex flex-1 items-center justify-center">
      <div className="w-full max-w-sm space-y-6">
        <h1 className="text-2xl font-bold text-center text-gray-900 dark:text-gray-100">ログイン</h1>
        ...
        <p className="text-sm text-center text-gray-600 dark:text-gray-400">
          アカウントがない方は{" "}
          <Link href="/register" className="underline hover:text-gray-900 dark:hover:text-gray-100">登録</Link>
        </p>
      </div>
    </div>
  );
